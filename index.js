...
async function chatWithKaiwa(text) {
  const response = await axios.post('https://openrouter.ai/api/v1/chat/completions', {
    ...
    messages: [
      { role: "user", content: `Hãy trả lời câu hỏi sau:\n\n"${text}"\n\nsao cho tự nhiên, ngắn gọn, giống người Nhật nhất bằng tiếng Nhật và có thể đặt câu hỏi phù hợp với mạch hội thoại và tự nhiên như người Nhật. Hãy thêm phần phiên âm bằng hiragana. ` }
    ],
    max_tokens: 100,
    temperature: 0.5
  }, {
